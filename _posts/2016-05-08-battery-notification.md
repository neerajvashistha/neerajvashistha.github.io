...
The notification system in Ubuntu based distro is quite simple just a command <a href="https://wiki.ubuntu.com/NotificationDevelopmentGuidelines">`notify-send`</a> its quite playful like you could write any script in shell, python, c or c# and make it working or no need of that too just you can say hello world too and a notification will pop on the desktop, like `notify-send "hello world"`
